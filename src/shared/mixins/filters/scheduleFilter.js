    ...
    filterBySchedule(flights, { departure, arrival }) {
      ...
      if (departure) {
        flights = flights.filter(function (flight) {
          const flightDatetime = new Date(flight.departureDate)
          ...
          const flightSchedule = flightDatetime.getTime()
          const desiredSchedule = desiredDeparture.getTime()
      ...
      if (arrival) {
        flights = flights.filter(function (flight) {
          const flightDatetime = new Date(flight.arrivalDate)
          ...
          const flightSchedule = flightDatetime.getTime()
          const desiredSchedule = desiredArrival.getTime()
          return flightSchedule <= desiredSchedule
        })
      }
